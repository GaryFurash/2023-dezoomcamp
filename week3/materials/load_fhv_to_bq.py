...
def hello_world(request):
    ...
    for month in range(4, 13):
        ...
        url = 'https://github.com/DataTalksClub/nyc-tlc-data/releases/download/fhv/fhv_tripdata_2019-{:02d}.csv.gz'.format(
            month)
        ...
        with tempfile.NamedTemporaryFile() as f:
            ...
            job.result()
            logging.info(
                "Data for month %d successfully loaded into table %s.", month, table_id)
